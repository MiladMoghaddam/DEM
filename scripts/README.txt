The purpose of this work is to propose 3 novel techniques to optimize the energy of a network-on-chip based chip
...
This work is implemented with sniper simulator.
